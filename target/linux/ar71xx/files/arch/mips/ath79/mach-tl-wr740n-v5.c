/*
 *  TP-LINK TL-WR740ND v5/TL-WR340G+ v7 board support
 *
...
#define TL_WR740NV5_GPIO_BTN_RESET_WPS	11
...
#define TL_WR740NV5_GPIO_USB_POWER	8
...
static struct gpio_keys_button tl_wr740nv5_gpio_keys[] __initdata = {
	{
		...
		.gpio		= TL_WR740NV5_GPIO_BTN_RESET_WPS,
		.active_low	= 0,
	}
};
...
static void __init tl_ap121_setup(void)
{
	...
	gpio_request_one(TL_WR740NV5_GPIO_USB_POWER,
...
MIPS_MACHINE(ATH79_MACH_TL_WR340G_V7, "TL-WR340G-v7",
	     "TP-LINK TL-WR340G+ v7", tl_wr740nv5_setup);
